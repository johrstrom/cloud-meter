...
export class MenuProvider {
  ...
  constructor(private service: InquryService) { }

  public getMenuForItem(item: string) {
  ...
  ThreadGroupMenu = [
    {
      ...
      click: (item, event) => {
        let node = this.service.getTestElement("thread-group");
   ...
   TopLevelMenu = [
    {
      ...
      subMenus: [
        ...
        },
        {
          ...
          click: (item, event) => {},
          subMenus: this.LogicControllerMenu
        },
        {
          enabled: true,
          visible: (item: any) => true,
          ...
          click: (item, event) => {},
          subMenus: this.ConfigElementMenu
        },
        {
          enabled: true,
          visible: (item: any) => true,
        ...
        },
        {
          ...
          click: (item, event) => {},
          subMenus: this.PreProcessorMenu
        },
        {
          enabled: true,
          visible: (item: any) => true,
        ...
        },
        {
          ...
          click: (item, event) => {},
          subMenus: this.PostProcessorMenu
        },
        {
          enabled: true,
          visible: (item: any) => true,
