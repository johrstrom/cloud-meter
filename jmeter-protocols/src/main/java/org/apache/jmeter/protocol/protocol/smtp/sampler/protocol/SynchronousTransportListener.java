...
import org.slf4j.Logger; // this comes out of logkit.jar and not
...
public class SynchronousTransportListener extends TransportAdapter {
	...
	private static final Logger log = LoggerFactory.getLogger(SynchronousTransportListener.class);
